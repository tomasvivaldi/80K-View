...
function AnswerSection() {
  ...
  const submitAllCategories = () => {
    ...
    for (const category of CategoryNames) {
      ...
      console.log(`Submitting ${category} dataaaa:`, categoryData);
  ...
  const onSubmit = handleSubmit(async (submitAllCategories: MyFormData) => {
    console.log('formData being passed on onSubmit!!!', submitAllCategories);
    ...
    try {
      ...
      for (const category of CategoryNames) {
        ...
        console.log('data on LOOP', submitAllCategories)
  
        if (!submitAllCategories || !submitAllCategories.score || !submitAllCategories.notes || !submitAllCategories.action_plan) {
        ...
        await (async () => {
          ...
          switch (category) {
             case "career_work":
            console.log('Submitting career_work submitAllCategories:', submitAllCategories);
            return addCareerWorkInfo({
              variables: {
                username: session?.user?.name,
                score: parseFloat(submitAllCategories.score.toString()),
                notes: submitAllCategories.notes,
                action_plan: submitAllCategories.action_plan,
                created_at: new Date().toISOString(),
              },
            });
          
            case "community":
              console.log('Submitting community submitAllCategories:', submitAllCategories);
            ...
            case "environment":
              console.log('Submitting environment submitAllCategories:', submitAllCategories);
            ...
            case "family_friends":
              console.log('Submitting family_friends submitAllCategories:', submitAllCategories);
            ...
            case "fun_relaxation":
              console.log('Submitting fun_relaxation submitAllCategories:', submitAllCategories);
            ...
            case "growth_learning":
              console.log('Submitting growth_learning submitAllCategories:', submitAllCategories);
            ...
            case "health_fitness":
              console.log('Submitting health_fitness submitAllCategories:', submitAllCategories);
            ...
            case "money_finances":
              console.log('Submitting money_finances submitAllCategories:', submitAllCategories);
            ...
            case "partner_love":
              console.log('Submitting partner_love submitAllCategories:', submitAllCategories);
            ...
            case "spirituality":
              ...
              console.log('submitAllCategories keys:', Object.keys(submitAllCategories));
              console.log('Submitting spirituality submitAllCategories:', submitAllCategories);
              return addSpiritualityInfo({
                variables: {
                  username: session?.user?.name,
                  score: parseFloat(submitAllCategories.score.toString()), // Access the values from formsubmitAllCategories
                  notes: submitAllCategories.notes,
                  action_plan: submitAllCategories.action_plan,
                  created_at: new Date().toISOString(),
              },
        ...
        <button
          onClick={() => {
            if (page === PageNames.length - 1) {
              console.log('allCategoryFormData before submitting:', allCategoryFormData);
              onSubmit(submitAllCategories); // Pass the entire allCategoryFormData object here
            } else {
              handleNextClick();
            }
          }}
