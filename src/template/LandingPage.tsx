  ...
  return (
    <div className="max-w-7xl mx-auto p-4 space-y-8">
      <div className="space-y-6 md:space-y-8 bg-gradient-to-r from-blue-600 via-cyan-600 to-blue-500 p-6 md:p-8 rounded-xl text-white shadow-lg">
        <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold leading-none">Welcome to 80k View</h1>
        <p className="text-sm sm:text-xl md:text-2xl font-light">Anxiety and depression rates are at an all-time high. Our rapidly changing world, the overwhelming plethora of options, and the resulting decision fatigue can often leave us feeling unfulfilled and lost. We're here to help.</p>
        <p className="text-sm sm:text-xl md:text-2xl font-light">80k View offers a comprehensive and reflective tool that can help you navigate the complexities of life. We don't tell you what to do but help you identify key trends and potential opportunities to make informed decisions based on a comprehensive outlook. Dive in and start building a life story to be proud of!</p>
      </div>
      <div className=" px-2 sm:px-4 p-2 rounded-md my-2 space-y-2">
        <h2 className="text-2xl lg:text-5xl font-semibold text-gray-800 dark:text-slate-100">Why choose 80k View?</h2>
        <ul className="list-disc list-inside text-base sm:text-lg lg:text-2xl text-gray-700 dark:text-slate-200">
      ...
      <h2 className="text-2xl lg:text-5xl font-semibold text-gray-800 dark:text-slate-100 sm:mx-6">Here's what 80k View looks like in action:</h2>
      <ExampleData />
