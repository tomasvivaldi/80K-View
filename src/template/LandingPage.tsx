...
const LandingPage: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto p-4 space-y-8">
      ...
      <div className="bg-gray-100 shadow-lg px-4 p-2 rounded-md my-2 space-y-2">
        <h2 className="text-2xl font-semibold text-gray-800">Why choose 80k View?</h2>
      ...
      <h2 className="text-2xl font-semibold text-gray-800 mx-6">Here's what 80k View looks like in action:</h2>
      <ExampleData />
      <div className="text-center py-12">
        <h2 className="text-2xl font-semibold text-gray-800 py-2">Ready to take control of your life?</h2>
